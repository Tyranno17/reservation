...
function openEditReservationModal(reservationId) {
  ...
  $("#viewReservationModal").one("hidden.bs.modal", showEditReservationModal);
  $("#viewReservationModal").modal("hide");
    ...
    // Code pour gérer la soumission du formulaire de création de réservation
    $(document).ready(function () {
  ...
  $("#viewReservationModal .modal-body").load("view_reservation.php?id=" + reservationId, function () {
    $("#viewReservationModal .edit-reservation").attr("data-reservation-id", reservationId);
    attachEditReservationHandler();
  });
  ...
  <script>
    function openCreateReservationModal(clickedDate) {
      $("#createReservationModal .modal-body").load("create_reservation.php?date=" + clickedDate);
      $("#createReservationModal").modal("show");
    }
  </script>

  <script>
    $(document).on("click", ".edit-reservation", function (e) {
  e.preventDefault();
  var reservationId = $(this).data("reservation-id");
  console.log("Clic sur le lien Modifier pour la réservation", reservationId);
  $("#viewReservationModal").modal("hide"); // Fermer la modale de visualisation

  // Attendez que la modale de visualisation soit complètement cachée
  $("#viewReservationModal").on("shown.bs.modal", function () {
