...
$query = "SELECT r.id, r.date_debut, r.date_fin, r.utilisateur_id, r.destination, u.prenom, u.nom, v.marque, v.modele, v.immatriculation, s.nom
FROM reservation r
...
function transformRowToEvent($row)
{
  ...
  return [
    ...
    'extendedProps' => [
      ...
      'user_id' => $row['utilisateur_id'], // Ajoutez cette ligne
      'service' => $row['nom'],
...
<body data-current-user-id="<?php echo $_SESSION['utilisateur_id']; ?>">
