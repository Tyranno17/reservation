...
$sql = "SELECT r.id, r.date_debut, r.date_fin, r.destination, u.prenom, u.nom, v.marque, v.modele, v.immatriculation, s.nom AS service, r.utilisateur_id
        FROM reservation r
...
<div data-creator-id="<?php echo $reservation['utilisateur_id']; ?>">
