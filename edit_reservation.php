...
<?php endif; ?>
<!-- Le contenu de la fenêtre modale d'édition de réservation commence ici -->
    <!-- <h1>Modifier une réservation</h1> -->

    <form action="edit_reservation.php?id=<?php echo $reservation_id; ?>" method="post" id="editReservationForm">
            ...
            <select class="form-select" name="vehicule_id" id="vehicule_id">
                ...
                <?php while ($vehicule = $result_vehicules->fetch_assoc()): ?>
                    <option value="<?php echo $vehicule['id']; ?>" data-service-id="<?php echo $vehicule['service_id']; ?>"
                        <?php if ($vehicule['id'] == $reservation['vehicule_id'])
                            echo 'selected'; ?>>
...
<!-- Le contenu de la fenêtre modale d'édition de réservation se termine ici -->
